...
export class SlackService {
  public static app_mention = new Subject<IEventPayload>();
  public static slash_command = new Subject<ISlashPayload>();
  public static channel_created = new Subject<IEventPayload>();
  public static channel_delete = new Subject<IEventPayload>();
  public static channel_rename = new Subject<IEventPayload>();
  public static channel_archive = new Subject<IEventPayload>();
  public static channel_unarchive = new Subject<IEventPayload>();
  public static channel_history_changed = new Subject<IEventPayload>();
  public static dnd_updated = new Subject<IEventPayload>();
  public static dnd_updated_user = new Subject<IEventPayload>();
  public static im_created = new Subject<IEventPayload>();
  public static im_open = new Subject<IEventPayload>();
  public static im_close = new Subject<IEventPayload>();
  public static im_history_changed = new Subject<IEventPayload>();
  public static group_open = new Subject<IEventPayload>();
  public static group_close = new Subject<IEventPayload>();
  public static group_archived = new Subject<IEventPayload>();
  public static group_unarchived = new Subject<IEventPayload>();
  public static group_rename = new Subject<IEventPayload>();
  public static group_history_changed = new Subject<IEventPayload>();
  public static message_groups = new Subject<IEventPayload>();
  public static file_created = new Subject<IEventPayload>();
  public static file_shared = new Subject<IEventPayload>();
  public static file_unshared = new Subject<IEventPayload>();
  public static file_public = new Subject<IEventPayload>();
  public static file_private = new Subject<IEventPayload>();
  public static file_changed = new Subject<IEventPayload>();
  public static file_deleted = new Subject<IEventPayload>();
  public static file_comment_added = new Subject<IEventPayload>();
  public static file_comment_edited = new Subject<IEventPayload>();
  public static file_comment_deleted = new Subject<IEventPayload>();
  public static member_joined_channel = new Subject<IEventPayload>();
  public static member_left_channel = new Subject<IEventPayload>();
  public static pin_added = new Subject<IEventPayload>();
  public static pin_removed = new Subject<IEventPayload>();
  public static user_change = new Subject<IEventPayload>();
  public static team_join = new Subject<IEventPayload>();
  public static star_added = new Subject<IEventPayload>();
  public static star_removed = new Subject<IEventPayload>();
  public static reaction_added = new Subject<IEventPayload>();
  public static reaction_removed = new Subject<IEventPayload>();
  public static emoji_changed = new Subject<IEventPayload>();
  public static team_rename = new Subject<IEventPayload>();
  public static team_domain_change = new Subject<IEventPayload>();
  public static email_domain_changed = new Subject<IEventPayload>();
  public static subteam_created = new Subject<IEventPayload>();
  public static subteam_updated = new Subject<IEventPayload>();
  public static subteam_members_changed = new Subject<IEventPayload>();
  public static subteam_self_added = new Subject<IEventPayload>();
  public static subteam_self_removed = new Subject<IEventPayload>();
  public static message_channels = new Subject<IEventPayload>();
  public static messahge_mpim = new Subject<IEventPayload>();
  public static link_shared = new Subject<IEventPayload>();
  public static message_im = new Subject<IEventPayload>();

  /*
   * This method will return then appropriate subject to listen to the event
   */
  public static handle(type:string):Subject<IEventPayload> {
